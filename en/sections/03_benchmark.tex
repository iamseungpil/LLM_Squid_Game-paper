...
The price range is set so that the relative price spans both sides of the dominance line within a session. With $r = 10$ and a ten-round session, a decision point at round $t$ leaves at most $10(10 - t)$ points to be won, and that ceiling falls from 90 to 10 as the session runs. A price of 30 is therefore a third of the ceiling at round 1 and three times it at round 9; a price of 5 exceeds the ceiling only in the final round, where no offer is made. The ladder therefore reaches both sides of the line within a session, which is what gives the estimator of Section~\ref{sec:estimation} a curve to fit rather than a single region. Appendix~\ref{app:pilot} reports the ablation that placed this range: on a wider ladder the payment rate was already zero at 40 and every rung above it was dead.
