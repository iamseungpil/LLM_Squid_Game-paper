...
Each model was run for 180 sessions (720 in total) under paired seeds 43--72. Gemini-2.5-flash was served through the Google AI Studio API, and Qwen3-Next-80B, GPT-OSS-20B, and Nemotron-3-Nano-30B through the Ollama Cloud API (sampling and session-parameter details in \S\,A.2).
